...
<div class="p-3 space-y-6">
  ...
  <div class="card bg-base-100 border border-base-300">
    <div class="card-body">
       ...
       <div class="flex gap-2" title={!canLead ? $_("common.noPermissions") : ""}>
      ...
      <div class="absolute top-2 left-2 z-1"><ProjectBadge project={project} /></div>
      <div class="flex items-center gap-4 mt-5">
        <AvatarComponent icon={project.icon ?? null} name={project.name} big={true} />
        <div class="min-w-0">
          <div class="text-2xl font-bold truncate max-w-full">{project.name}</div>
